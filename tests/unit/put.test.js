...
describe('PUT /v1/fragments/:id - Image Fragments (PNG, GIF, JPG/JPEG, WEBP)', () => {
  ...
  const testImageData = {
    'image/png': fs.readFileSync(path.join(__dirname, '../images/genTest.png')),
    'image/jpeg': fs.readFileSync(path.join(__dirname, '../images/genTest.jpg')),
    'image/gif': fs.readFileSync(path.join(__dirname, '../images/genTest.gif')),
    'image/webp': fs.readFileSync(path.join(__dirname, '../images/genTest.webp')),
  };
