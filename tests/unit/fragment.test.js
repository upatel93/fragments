...
describe('Fragment class', () => {
  ...
  describe('Fragment()', () => {
    ...
    // this test added by me... to make sure I receive string only..
    test('ownerId must be a string', () => {
      expect(() => new Fragment({ ownerId: 12345, type: 'text/plain', size: 1 })).toThrow();
    });
    ...
    test('type must be a string', () => {
      expect(() => new Fragment({ ownerId: '1234', type: 1234, size: 1 })).toThrow();
    });
